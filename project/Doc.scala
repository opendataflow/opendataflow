...
object Scaladoc extends AutoPlugin {
  ...
  object CliOptions {
    val scaladocDiagramsEnabled = CliOption("opendataflow.scaladoc.diagrams", true)
    val scaladocAutoAPI = CliOption("opendataflow.scaladoc.autoapi", true)
  }
...
object UnidocRoot extends AutoPlugin {
  ...
  object CliOptions {
    val genjavadocEnabled = CliOption("opendataflow.genjavadoc.enabled", false)
  }
